...
namespace MachineLearningToolkit.ImageClassification
{
    public class ImageClassification
    {
        ...
        public List<Classification> Classify(string listPath)
        {
        ...
        private Classification Predict(Session sess, NDArray imgArr, string image)
        {
        ...
        //private Classification ParseResults(List<string> resultArr, string imagePath)
        //{
        //    var detectionsList = new List<Classification>();
